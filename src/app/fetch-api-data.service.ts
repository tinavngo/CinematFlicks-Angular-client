...
export class FetchApiDataService {
   ...
   * 
   * @param {any} movie - Post one favorite to user's favorites 
   ...
   * 
   * @param {any} movie - Remove one favorite from user's favorites 
   ...
   * 
   * @param {any} userDetails - Update userDetails in user's favorites
